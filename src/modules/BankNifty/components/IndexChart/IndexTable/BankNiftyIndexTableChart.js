...
const BankNiftyIndexTableChart = (props) => {
  const { data } = props;
  ...
  const skipColumns = [
    ...
    "DAY_PRICE_CHG",
    "CLOSE",
    "PCR_0_5_BANKNIFTY_PER",
    "PCR_1_BANKNIFTY_PER",
  ];

  const returnKey = (key) => {
    if (key === "PCR_0_5_BANKNIFTY_PER") {
      return "PCR 0.5 BANKNIFTY";
    } else if (key === "PCR_1_BANKNIFTY_PER") {
      return "PCR 1 BANKNIFTY";
    } else {
  ...
  const addPercentage = ["PCR_0_5_BANKNIFTY_PER"];
  const pcr1Percentage = ["PCR_1_BANKNIFTY_PER"];
      ...
      <div>
        ...
        <div className="flex-between">
          <div>
            ...
            <br />
            PCR_0_5_BANKNIFTY_PERCENTAGE:
            <span
              className={`${
                lastRecord["PCR_0_5_BANKNIFTY_PER"] > 50 ? "sell" : ""
              }`}
            >
              {lastRecord["PCR_0_5_BANKNIFTY_PER"]}%
            </span>
          </div>
          ...
          <div>
            ...
            <br />
            PCR_1_0_BANKNIFTY_PERCENTAGE:
            <span
              className={`${
                lastRecord["PCR_1_BANKNIFTY_PER"] > 50 ? "buy" : ""
              }`}
            >
              {lastRecord["PCR_1_BANKNIFTY_PER"]}%
            </span>
          </div>
        </div>
...
export default BankNiftyIndexTableChart;
